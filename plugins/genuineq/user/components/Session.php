...
class Session extends ComponentBase
{
    ...
    const SECURITY_ERROR_WRONG_TYPE  = -4;
    ...
    public function defineProperties()
    {
        return [
            ...
            'allowedUserTypes' => [
                'title'       => 'genuineq.user::lang.component.session.backend.allowed_types_title',
                'description' => 'genuineq.user::lang.component.session.backend.allowed_types_description',
                'placeholder' => '*',
                'type'        => 'set',
                'default'     => []
            ]
    ...
    public function getAllowedUserTypesOptions()
    {
    ...
    public function onRun()
    {
        ...
        if ((self::SECURITY_ERROR_NOT_GUEST == $userSecurity) ||
