!function () {
    if (!window.hasCookieConsent) {
        ...
        var e = "cookieconsent_options", t = "update_cookieconsent_options", n = "cookieconsent_dismissed",
            // with external directory      i = "//cdnjs.cloudflare.com/ajax/libs/cookieconsent2/1.0.9/";
            i = "/themes";
                ...
                options: {
                    ...
                    markup: [
                        ...
                        '<p class="cc_message">{{options.message}} ' +
                            // added target="_blank" bellow
                        '<a data-cc-if="options.link" target="_blank"  class="cc_more_info" href="{{options.link || "#null"}}">{{options.learnMore}}</a></p>',
                    ...
                    this.options.container ? this.container = document.querySelector(this.options.container) : this.container = document.body,
                        this.containerClasses = "", navigator.appVersion.indexOf("MSIE 8") > -1 && (this.containerClasses += " cc_ie8")
                }, loadTheme: function (e) {
                    var t = this.options.theme;
                    -1 === t.indexOf(".css") && (t = "/themes/esense/assets/scss/cookie-consent.css");  //(t = i + t + ".css");
