title = "Editează profil școală"
url = "/school/profile-edit"
layout = "web-app"
description = "Pagina de editare a profilului"
is_hidden = 0
        ...
        <div class="col-12 my-3">
            <div class="d-flex align-items-center justify-content-end">
                <div class="d-none">
                    ...
                    <a class="ml-3 text-black" href="{{ 'school/dashboard'|page }}">{{'page.school.dashboard.profile.back.link.text'|_}}</a>
                </div>
                <div>
                    <a role="button" data-toggle="modal" data-target="#changePasswodTeacherModal" class="btn btn-sm btn-secondary d-flex align-items-center justify-content-around py-1 px-2" style="width:140px;">
                        ...
                        {{'page.school.dashboard.edit.profile.change.password.btn'|_}}
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="shadow-lg rounded bg-white p-0 p-md-5">
                        ...
                        <form method="POST" data-request="onAvatarUpdate" data-request-validate data-request-flash data-request-files>
                            <div class="row">
                                <div class="col-12">
                                    <p class="display-2 text-medium-dark form-styles p-0 m-0 mb-3">{{'page.school.dashboard.profile.avatar.text'|_}}</p>
                                    <div class="d-flex align-items-center mt-3 mb-4">
                                        <button role="button" type="submit" class="btn btn-sm btn-secondary d-flex align-items-center justify-content-around py-1 px-2" style="width:140px;">
                                            ...
                                            {{'page.school.dashboard.edit.profile.btn.text'|_}}
                                        </button>
                                        {% if user.avatar %}
                        ...
                        <!-- Edit profile form -->
                        <form id="form" method="POST" data-request='onSchoolProfileUpdate'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" name="school_name" class="form-control" id="school_name" aria-describedby="school_nameHelp" placeholder="{{'page.school.dashboard.form.input.school.name.placeholder'|_}}" style="font-style:italic;" value="{{ user.profile.name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="surname" class="form-control" id="surname" aria-describedby="surnameHelp" placeholder="{{'page.school.dashboard.form.input.last.name.placeholder'|_}}" style="font-style: italic;" value="{{ user.surname }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control" id="name" aria-describedby="nameHelp" placeholder="{{'page.school.dashboard.form.input.first.name.placeholder'|_}}" style="font-style: italic;" value="{{ user.name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="number" name="phone" class="form-control" id="phone" aria-describedby="phoneHelp" placeholder="{{'page.school.dashboard.form.input.phone.placeholder'|_}}" style="font-style: italic;" value="{{ user.profile.phone }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="{{'page.school.dashboard.form.input.email.placeholder'|_}}" style="font-style: italic;" value="{{ user.email }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group register-select">
                                            <select name="county" id="specialistCounty" class="form-control border outline-none selectpicker" data-live-search="true" data-none-results-text="{{'page.school.dashboard.form.select.no.result'|_}}" data-style="btn-white">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group register-select">
                                            <select name="city" id="specialistCity" class="form-control border outline-none selectpicker" data-none-results-text="{{'page.school.dashboard.form.select.no.result'|_}}" data-live-search="true" data-style="btn-white" disabled></select>
                                        </div>
                                    </div>
                            ...
                            <div class="shadow rounded p-3 py-4 mt-5">
                                <p class="display-2 text-medium-dark form-styles pl-3">{{'page.school.dashboard.form.description'|_}}</p>
                                <div class="col-12">
                                    <div class="form-group">
                            ...
                            <div class="col-12 mt-5 mb-5 mb-lg-0">
                                <div class="d-flex justify-content-end">
                                    <button role="button" type="submit" class="btn btn-sm btn-secondary px-5">{{'page.school.dashboard.edit.profile.btn'|_}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
