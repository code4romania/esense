    ...
    <div class="row">
        ...
        <div class="col-12 my-3">
            <div class="d-flex align-itmes-center">
                ...
                <a class="ml-3 text-black" href="{{ 'school/student'|page({studentId: lesson.connection.student.id }) }}">{{ 'page.school.dashboard.lesson.student.back'|_ }}</a>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="d-flex align-items-center mb-2">
                <br>
                <img class="img-fluid" src="{{ 'assets/img/svg/dashboard/user.svg'|theme }}">
                <span class="ml-2 display-4 text-black">{{ lesson.connection.specialist.full_name }}</span>
            </div>
        </div>
