            ...
            <div class="rounded shadow bg-white p-3 p-lg-4">
                ...
                <form method="POST" data-request="onCreateStudent" data-request-validate data-request-flash data-request-files>
                    <div class="row mt-2">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="d-flex">
                                        <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active btn btn-sm btn-outline border-dark px-3 px-lg-5" id="v-pills-female-tab" data-gender="female" data-toggle="pill" href="#v-pills-female" role="tab" aria-controls="v-pills-female" aria-selected="true">{{'page.specialist.dashboard.student.add.gen.fata'|_}}</a>
                                            <a class="nav-link ml-3 ml-lg-4 btn btn-sm btn-outline border-dark px-3 px-lg-5" id="v-pills-male-tab" data-gender="male" data-toggle="pill" href="#v-pills-male" role="tab" aria-controls="v-pills-male" aria-selected="false">{{'page.specialist.dashboard.student.add.gen.baiat'|_}}</a>
                                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex">
                                <input type="text" class="form-control onChangeValue" name="surname" id="surname" placeholder="{{'page.specialist.dashboard.student.profile.input.last.name'|_}}">
                                <span class="text-danger ml-2">*</span>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex">
                                <input type="text" class="form-control onChangeValue" name="name" id="name" placeholder="{{'page.specialist.dashboard.student.profile.input.first.name'|_}}">
                                <span class="text-danger ml-2">*</span>
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-md-6 ml-lg-0 pl-lg-0">
                                    <div class="d-flex mb-3 mb-md-0">
                                        <div class="form-check">
                                            ...
                                            <input class="onChangeValue" name="hearing_impairment" id="hearing_impairment" type="checkbox" data-toggle="toggle" data-onstyle="secondary" data-offstyle="gray-medium" data-size="xs" data-on="{{'page.specialist.dashboard.student.toggle.yes'|_}}" data-off="{{'page.specialist.dashboard.student.toggle.no'|_}}" data-style="ios">
                                        </div>
                                        <span class="text-danger ml-2">*</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        <div class="form-check">
                                            ...
                                            <input class="onChangeValue" name="visual_impairment" id="visual_impairment" type="checkbox" data-toggle="toggle" data-onstyle="secondary" data-offstyle="gray-medium" data-size="xs" data-on="{{'page.specialist.dashboard.student.toggle.yes'|_}}" data-off="{{'page.specialist.dashboard.student.toggle.no'|_}}" data-style="ios">
                                        </div>
                                        <span class="text-danger ml-2">*</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mb-5 mt-3">
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="add-student btn btn-sm text-white btn-gray-light px-lg-5" disabled>{{'page.specialist.dashboard.student.add.profile.submit.btn.text'|_}}</button>
                            </div>
                        </div>
