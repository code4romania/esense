title = "Profil elev"
url = "/specialist/student/:studentId"
layout = "web-app"
description = "Display a student"
is_hidden = 0
            ...
            <div class="bg-white rounded" style="box-shadow: 0px 0px 32px rgba(136, 152, 170, 0.15)">
                <div class="row">
                    ...
                    <div class="col-12 mb-5">
                        <div class="p-3 d-flex align-items-start justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <p class="p-0 m-0 mr-2 d-none d-md-block" style="line-height: 25px; color: #313131;">{{ 'page.specialist.dashboard.student.actions'|_ }}</p>
                                <div class="dropdown">
                    ...
                    <div class="col-12 col-lg-6" id="schedule-timeline">
                        {% partial 'web-app/general/schedule-timeline' title='page.specialist.dashboard.student.profile.schedule_timeline'|_ lessons=student.today_lessons allow_edit=true %}

                        <!-- Start game link -->
                        <div class="row">
                            <div class="col-6 py-3">
                                <a class="btn btn-secondary btn-lg display-4 roboto-family ml-3" href="esense://C:\Program Files (x86)\Esense\ScoliSpeciale.exe">
                            ...
                            <!-- Download game link -->
                            <div class="col-6 py-3">
                                <a class="btn btn-secondary btn-lg display-4 roboto-family ml-3"
                                href="{{ 'arhiva_joc/eSenseGamesInstall.zip' | media }}" download>
                                {{ 'page.specialist.dashboard.student.download_game'|_ }}
                                </a>
                            </div>
                        </div>
                        ...
                        <!-- Short description -->
                        <div class="col-12">
                            <p class="small">{{ 'page.specialist.dashboard.student.short_description'|_ }}</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4 d-none">
                        <div class="px-3 d-flex align-items-center justify-content-between">
                            <p class="p-0 m-0 text-gray-dark font-weight-bold">{{ 'page.specialist.dashboard.student.profile.frequent_exercises'|_ }}</p>
                        </div>
                                ...
                                {% for record in records.items %}
                                    <div class="item">
                                        <div class="rounded bg-white" style="box-shadow: 0px 0px 32px rgba(136, 152, 170, 0.15);">
                                            <div class="bg-white">
                                                <p class="p-0 m-0 pl-3 text-gray-dark">{{record.name}}</p>
                                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <p class="text-gray-dark font-weight-bold px-3">{{ 'page.specialist.dashboard.student.profile.exercises'|_ }}</p>
