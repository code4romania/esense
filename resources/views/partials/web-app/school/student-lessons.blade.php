        ...
        <tr>
            ...
            <td>
                <div class="pl-2 py-lg-4">
                    <a role="button" href="{{ 'school/lesson'|page({lessonId: lesson.id }) }}">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function updateLessons($month, $year) {
            $.request(
                'onSchoolStudentLessonsTableUpdate',
                {
                    data: {
                        month: $month,
                        year: $year
                    ...
                    update: {
                        'web-app/school/student-lessons': '#student-lessons-datatable-container'
                    }
                }
            );
        }
